...
public class GraphUtil {
	...
	private static final XRI3Segment XRI_ALLFILED_OAUTH_TOKEN = new XRI3Segment("(https://allfiled.com)=!1111$($oauth)$!($token)");

	private GraphUtil() { }

	public static String retrieveAccessToken(Graph graph) {

		ContextNode contextNode = graph.findContextNode(XRI_ALLFILED_OAUTH_TOKEN, false);
	...
	public static void storeAccessToken(Graph graph, String accessToken) {
		...
		ContextNode contextNode = graph.findContextNode(XRI_ALLFILED_OAUTH_TOKEN, true);
