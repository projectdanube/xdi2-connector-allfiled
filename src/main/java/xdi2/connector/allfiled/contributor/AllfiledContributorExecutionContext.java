...
/**
 * Methods for storing state related to the contributor.
 */
public class AllfiledContributorExecutionContext {

	private static final String EXECUTIONCONTEXT_KEY_USERS_PER_MESSAGEENVELOPE = AllfiledContributor.class.getCanonicalName() + "#userspermessageenvelope";
