...
<title>xdi2-connector-allfiled</title>
<link rel="stylesheet" target="_blank" href="style.css" TYPE="text/css" MEDIA="screen">
</head>
<body style="background-image: url('images/back.png'); background-repeat: repeat-y; margin-left: 60px;">

	<div class="header">
	<img src="images/allfiled-logo.png" align="middle">&nbsp;&nbsp;&nbsp;
	<img src="images/arrow.png" align="middle">&nbsp;&nbsp;&nbsp;
	<img src="images/logo64.png" align="middle">&nbsp;&nbsp;&nbsp;<span id="appname">xdi2-connector-allfiled</span>
	</div>
	...
	<p class="subheader">Obtain Allfiled API Access Token</p>
	...
	<p>The token is then stored in your XDI graph, where it is picked up and used by the XDI2 server to handle requests to your Allfiled context.</p>
	...
	<p>Certain parts of your graph will only be accessible if you have an Allfiled API access token.</p>
